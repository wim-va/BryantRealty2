...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ url('assets/images/product-1-720x480.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ url('assets/images/product-2-720x480.jpg') }}" alt="">
                        </div>
                        <div class="down-content">
                            <span>
                                <del><sup>$</sup>80 000</del> <sup>$</sup>70 000
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ url('assets/images/product-3-720x480.jpg') }}" alt="">
                        </div>
                        <div class="down-content">
                            <span>
                                <del><sup>$</sup>80 000</del> <sup>$</sup>70 000
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="cta-content text-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto nulla quo cum officia laboriosam.
                            Amet tempore, aliquid quia eius commodi, doloremque omnis delectus laudantium dolor reiciendis
                            non nulla! Doloremque maxime quo eum in culpa mollitia similique eius doloribus voluptatem
                            facilis! Voluptatibus, eligendi, illum. Distinctio, non!</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" id="tabs">
                <div class="col-lg-4">
                    <ul>
                        ...
                        <li><a href='#tabs-3'>Sunt hic recusandae vitae explicabo quidem laudantium corrupti non adipisci
                                nihil.</a></li>
                ...
                <div class="col-lg-8">
                    <section class='tabs-content'>
                        ...
                        <article id='tabs-2'>
                            <img src="{{ url('assets/images/blog-image-2-940x460.jpg') }}" alt="">
                        ...
                        <article id='tabs-3'>
                            <img src="{{ url('assets/images/about-image-3-940x460.jpg') }}" alt="">
    ...
    <section class="section section-bg" id="call-to-action"
        style="background-image: url(
            {{ url('assets/images/banner-image-1-1920x500.jpg') }}
            )">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="{{ url('assets/images/line-dec.png') }}" alt="waves">
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="{{ url('assets/images/features-first-icon.png') }}" alt="First One">
                            </div>
