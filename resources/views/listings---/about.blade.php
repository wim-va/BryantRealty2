            ...
            <div class="row" id="tabs">
                ...
                <div class="col-lg-8">
                    <section class='tabs-content'>
                        <article id='tabs-1'>
                            <img src="{{ url('assets/images/about-image-1-940x460.jpg') }}" alt="">
                            <h4>Our Goals</h4>
                        ...
                        <article id='tabs-2'>
                            <img src="{{ url('assets/images/about-image-2-940x460.jpg') }}"></script>
                        ...
                        <article id='tabs-3'>
                            <img src="{{ url('assets/images/about-image-3-940x460.jpg') }}"></script>
